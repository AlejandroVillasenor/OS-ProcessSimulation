...
class Process{
    ...
    public:
        Process(string op, float result, int timeMax, int timeTrans, int timeLle, int timeFin, int timeResp, bool banResp, int timeEsp, int timeRet, int timeBlocked, int ID, bool banerror, int timeTransQuantum){
            this->op = op;
            this->result = result;
